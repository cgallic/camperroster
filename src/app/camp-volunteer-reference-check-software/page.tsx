...
export default function SeoLandingPage() {
  ...
  const faqs = [
  {
    "q": "What happens if a reference doesn't answer the first phone call?",
    "a": "KaiCalls automatically retries at smart intervals and sends a polite SMS reminder to schedule a callback at their convenience."
  },
  {
    "q": "Is the reference audio compliant with state recording laws?",
    "a": "Yes. KaiCalls includes standard two-party consent disclosure announcements before conducting the character interview."
  }
];
  ...
  return (
    <main className="space-y-16 sm:space-y-24 pb-24 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-10">
      ...
      <section className="bg-stone-100 rounded-3xl p-6 sm:p-10 space-y-6">
        ...
        <b className="font-bold text-rose-900 block">Endless Phone Tag</b>
        <p className="text-xs text-stone-600">Directors spend 40–60 hours every spring leaving voicemails for pastors, employers, and professors.</p>
      </div>
      <div className="p-4 rounded-2xl bg-white border border-stone-200 space-y-1">
        <b className="font-bold text-rose-900 block">Spam Filter Traps</b>
        <p className="text-xs text-stone-600">Email reference forms often land in junk folders, delaying counselor onboarding until opening day.</p>
      </div>
      <div className="p-4 rounded-2xl bg-white border border-stone-200 space-y-1">
        <b className="font-bold text-rose-900 block">Inconsistent Vetting</b>
        <p className="text-xs text-stone-600">Different staff members ask different questions, leaving gaps in child safety and character screening.</p>
      </div>
        </div>
      </section>
      ...
      <section className="space-y-6">
        <div className="text-center max-w-2xl mx-auto space-y-1">
          ...
          <h2 className="font-display font-black text-2xl sm:text-4xl text-stone-950">Camp Volunteer Reference Checking vs CamperRoster</h2>
        </div>
        <div className="overflow-x-auto border-2 border-stone-200 rounded-2xl bg-white shadow-md">
          <table className="w-full text-left text-xs sm:text-sm">
            ...
            <tbody className="divide-y divide-stone-200 text-stone-800">
              <tr>
        <td className="p-4 font-bold">Reference Call Delivery</td>
        <td className="p-4 text-rose-700 font-bold">Manual Staff Calling (Weeks)</td>
        <td className="p-4 bg-emerald-50/50 text-emerald-900 font-black">Automated 2-Min KaiCalls Voice AI</td>
      </tr>
      <tr>
        <td className="p-4 font-bold">Audio & Transcript Logging</td>
        <td className="p-4 text-stone-600">Manual Hand-Written Notes</td>
        <td className="p-4 bg-emerald-50/50 text-emerald-900 font-black">Full Audio Playback & Timestamped Text</td>
      </tr>
      <tr>
        <td className="p-4 font-bold">Safety Assessment Scoring</td>
        <td className="p-4 text-stone-600">Subjective Guesswork</td>
        <td className="p-4 bg-emerald-50/50 text-emerald-900 font-black">Standardized AI Character & Risk Score</td>
      </tr>
            </tbody>
          </table>
        </div>
      ...
      <section className="space-y-6">
        ...
        <b className="font-black text-stone-900 block">🎙️ Real Voice Telephony</b>
        <p className="text-xs sm:text-sm text-stone-600">KaiCalls places a natural, conversational telephone call to the reference's mobile phone and conducts a 2-minute safety interview.</p>
      </div>
      <div className="p-5 rounded-2xl bg-white border-2 border-stone-200 space-y-2">
        <b className="font-black text-stone-900 block">📋 Director Command Dashboard</b>
        <p className="text-xs sm:text-sm text-stone-600">Review all completed reference checks, listen to call audio recordings, and approve applicants in one click.</p>
      </div>
        </div>
      </section>
      ...
      <section className="bg-forest-950 text-white rounded-3xl p-8 sm:p-14 text-center space-y-6 shadow-2xl border-2 border-emerald-400">
        ...
        <h2 className="font-display font-black text-3xl sm:text-5xl text-white">
          Automate your camp staff reference checks today.
        </h2>
        <p className="text-sm sm:text-base text-stone-300 max-w-xl mx-auto leading-relaxed">
          Save 40+ hours of phone tag and ensure 100% verified counselor character screening.
        </p>
        <div className="pt-2 flex flex-col sm:flex-row justify-center gap-3">
          <Link
            href="/start"
