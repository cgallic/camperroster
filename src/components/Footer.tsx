        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
          ...
          <div className="space-y-4 text-xs">
            ...
            <ul className="space-y-2.5">
              ...
              <li><Link href="/portal" className="text-amber-400 hover:text-amber-300 font-bold transition-colors">Parent Household Portal</Link></li>
              <li><Link href="/admin/checkin" className="hover:text-white transition-colors">Express Gate QR Scanner</Link></li>
              <li><Link href="/admin/bunk-notes" className="hover:text-white transition-colors">Daily Bunk Notes Printer</Link></li>
              <li><Link href="/counselor" className="hover:text-white transition-colors">Counselor Mobile Roster</Link></li>
